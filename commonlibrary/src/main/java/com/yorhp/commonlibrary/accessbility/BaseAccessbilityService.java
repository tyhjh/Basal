package com.yorhp.commonlibrary.accessbility;
...
public abstract class BaseAccessbilityService extends AccessibilityService {
     ...
     * @param callback
     */
    protected boolean clickOnScreen(float x, float y, int duration, GestureResultCallback callback) {
        Path path = new Path();
        path.moveTo(x, y);
        return gestureOnScreen(path, 0, duration, callback);
    }
     ...
     * @param callback
     */
    protected boolean gestureOnScreen(Path path, long startTime, long duration,
     ...
     * @return View
     */
    public AccessibilityNodeInfo findViewByText(AccessibilityNodeInfo accessibilityNodeInfo, String text) {
        if (accessibilityNodeInfo == null) {
            return null;
        }
        List<AccessibilityNodeInfo> nodeInfoList = accessibilityNodeInfo.findAccessibilityNodeInfosByText(text);
